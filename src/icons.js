...
const PARTS = {
  ...
  // Ours, drawn to the set's weight: a dial's needle on its hub, for the row
  // that says which of the two shapes the needle is. Lucide's `gauge` is the
  // nearest thing it has, and that one is already the glass row two lines
  // below - one menu cannot say two things with one drawing.
  'needle':
    svg`<circle cx="11" cy="18" r="2.5" /> <path d="m12.8 16.2 6.2-8.2" />`,
};
